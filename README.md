...
## ⚙️ CDC (Change Data Capture): ***(đang cập nhật)*** 
### 📝 Khái niệm:
...
## ⚙️ Apache Iceberg: ***(đang cập nhật)*** 
### 📝 Khái niệm:
...
## ⚙️ Build data pipeline: ***(đang cập nhật)*** 
### 📝 Khái niệm: 
...
## ⚙️ SQL (Structured Query Language): ***(đang cập nhật)*** 
### 1️⃣ PL/SQL (Procedural Language/Structured Query Language)
### 2️⃣ Functions
